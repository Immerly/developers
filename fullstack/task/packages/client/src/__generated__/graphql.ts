...
export type GetExchangeRatesQuery = { __typename?: 'Query', exchangeRates?: Array<{ __typename?: 'ExchangeRate', createdAtUtc: any, validFor: string, order: number, country: string, currency: string, currencyCode: string, rate: number }> | null };
